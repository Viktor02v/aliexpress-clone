					...
					<li @mouseenter="isAccountMenu = true" @mouseleave="isAccountMenu = false"
						...
						<div id="AccountMenu" v-if="isAccountMenu"
							...
							<ul class="bg-white">
								...
								<li v-if="user" @click="logout" class="text-[13px] py-2 px-4 w-full hover:bg-gray-200">
									Sing out
								</li>
							</ul>
						</div>
						...
						<div class="relative">
							...
							<div class="absolute bg-white max-w-[700px] h-auto w-full">
								<div v-if="false" class="p-1">
									<NuxtLink to="/item/1"
										class="flex items-center justify-between w-full cursor-pointer hover:bg-gray-200">
						...
						<button class="relative md:block hidden" @mouseenter="isCartHover = true"
							...
							<div class="min-w-[40px]">
								<Icon name="ph:shopping-cart-simple-light" size="33"
									:color="isCartHover ? '#FF4646' : '#000000'" class="transition-colors duration-200" />
							</div>
						</button>
					</NuxtLink>
